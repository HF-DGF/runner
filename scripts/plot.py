...
def draw_result(output_dir, target):
    if "tbl2" in target:
        draw_figure5(output_dir, target+TYPE_SUFF)
    elif "fig7" in target:
        draw_figure7(output_dir, target+TYPE_SUFF)
    elif "fig8" in target:
        draw_figure8(output_dir, target+TYPE_SUFF)
    elif "fig9" in target:
        draw_figure9(output_dir, target+TYPE_SUFF)
    else:
